...
class TestAttendanceUtil:
    ...
    def season(self):
        ...
        return Season.objects.create(season=2024, current="y")
    ...
    def meeting_types(self):
        ...
        return {
            "reg": MeetingType.objects.create(
                meeting_typ="reg", meeting_nm="Regular Meeting", void_ind="n"
            ),
            "bns": MeetingType.objects.create(
                meeting_typ="bns", meeting_nm="Bonus Meeting", void_ind="n"
            ),
            "evnt": MeetingType.objects.create(
                meeting_typ="evnt", meeting_nm="Event", void_ind="n"
            ),
        }
    ...
    def approval_types(self):
        ...
        return {
            "unapp": AttendanceApprovalType.objects.create(
                approval_typ="unapp", approval_nm="Unapproved", void_ind="n"
            ),
            ...
            "rej": AttendanceApprovalType.objects.create(
                approval_typ="rej", approval_nm="Rejected", void_ind="n"
            ),
        }
    ...
    def test_get_meetings(self, season, meeting):
        ...
        with patch(
            "attendance.util.scouting.util.get_current_season", return_value=season
        ):
    ...
    def test_get_attendance_filter_by_user(
        self, season, meeting, test_user, admin_user, approval_types
    ):
    ...
    def test_get_attendance_filter_by_meeting(
        self, season, test_user, approval_types, meeting_types
    ):
    ...
    def test_save_attendance_create_new(
        self, season, meeting, test_user, approval_types
    ):
    ...
    def test_save_attendance_update_existing(
        self, season, meeting, test_user, approval_types
    ):
    ...
    def test_save_attendance_absent_auto_approves(
        self, season, meeting, test_user, approval_types
    ):
    ...
    def test_save_attendance_no_timeout_approved_raises_error(
        self, season, meeting, test_user, approval_types
    ):
    ...
    def test_save_attendance_defaults_to_unapproved(
        self, season, meeting, test_user, approval_types
    ):
    ...
    def test_get_attendance_report(
        self, season, meeting, test_user, approval_types, meeting_types
    ):
        ...
        with patch(
            ...
            assert (
                result[0]["reg_time_percentage"] == 67.0
            )  # 4/6 * 100 = 66.67 rounded to 67

    def test_get_attendance_report_only_approved_counted(
        self, season, meeting, test_user, approval_types
    ):
    ...
    def test_get_attendance_report_absent_not_counted(
        self, season, meeting, test_user, approval_types
    ):
...
class TestAttendanceViews:
    ...
    def test_attendance_view_get(
        self, api_rf, test_user, season, meeting, approval_types
    ):
    ...
    def test_attendance_report_view_get(
        self, api_rf, test_user, season, meeting, approval_types
    ):
        ...
        with patch(
            ...
            "attendance.util.user.util.get_users", return_value=[test_user]
        ), patch(
            "attendance.views.access_response"
        ) as mock_access:
            # Setup mock to call the function
            def call_fun(path, user_id, auth_obj, error_msg, fun):
                return fun()
