...
class TestAttendanceModelStringMethods:
    ...
    def test_meeting_type_str(self):
        ...
        meeting_type = MeetingType.objects.create(
            meeting_typ="team", meeting_nm="Team Meeting"
        )
    ...
    def test_meeting_str(self):
        ...
        meeting_type = MeetingType.objects.create(
            meeting_typ="build", meeting_nm="Build Session"
        )
    ...
    def test_attendance_str(self):
        ...
        attendance = Attendance.objects.create(
            user=user, meeting=meeting, season=season, approval_typ=approval_type
        )
...
class TestAttendanceModelMethods:
    ...
    def test_is_unapproved(self):
        ...
        user = User.objects.create_user(
            username="unappuser", email="unapp@test.com", password="pass123"
        )
        ...
        attendance = Attendance.objects.create(
            user=user, season=season, approval_typ=unapp_type
        )
    ...
    def test_is_approved(self):
        ...
        user = User.objects.create_user(
            username="appuser", email="app@test.com", password="pass123"
        )
        ...
        attendance = Attendance.objects.create(
            user=user, season=season, approval_typ=app_type
        )
    ...
    def test_is_rejected(self):
        ...
        user = User.objects.create_user(
            username="rejuser", email="rej@test.com", password="pass123"
        )
        ...
        attendance = Attendance.objects.create(
            user=user, season=season, approval_typ=rej_type
        )
...
class TestAttendanceModelFields:
    ...
    def test_meeting_type_void_default(self):
        ...
        meeting_type = MeetingType.objects.create(
            meeting_typ="test", meeting_nm="Test Meeting Type"
        )
    ...
    def test_attendance_absent_default(self):
        ...
        user = User.objects.create_user(
            username="absentuser", email="absent@test.com", password="pass123"
        )
        ...
        attendance = Attendance.objects.create(
            user=user, season=season, approval_typ=approval_type
        )
