...
class TestSendEmail:
    ...
    def test_send_email_single_recipient(self):
        ...
        with patch("general.send_message.get_template") as mock_get_template, patch(
            "general.send_message.EmailMultiAlternatives"
        ) as MockEmail, patch(
            "general.send_message.add_test_env_subject", return_value="Test Subject"
        ):
    ...
    def test_send_email_multiple_recipients(self):
        ...
        with patch("general.send_message.get_template") as mock_get_template, patch(
            ...
            send_email(
                ["test1@example.com", "test2@example.com"], "Subject", "template", {}
            )
...
class TestSendDiscordNotification:
    ...
    def test_send_discord_notification_success(self):
        ...
        with patch("general.send_message.requests.post") as mock_post, patch(
            "general.send_message.settings"
        ) as mock_settings, patch(
            "general.send_message.add_test_env_subject", return_value="Test Message"
        ):
...
class TestSendWebpush:
    ...
    def test_send_webpush_success(self):
        ...
        with patch("general.send_message.send_user_notification") as mock_send, patch(
            "general.send_message.add_test_env_subject", return_value="Test Subject"
        ):
    ...
    def test_send_webpush_long_body(self):
        ...
        with patch("general.send_message.send_user_notification") as mock_send, patch(
            "general.send_message.add_test_env_subject", return_value="Test"
        ):
            ...
            assert len(payload["notification"]["body"]) == 3450
