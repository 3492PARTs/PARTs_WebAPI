...
def schedule_type(db):
    ...
    return ScheduleType.objects.create(sch_typ="meeting", sch_nm="Meeting")
...
def competition_level(db):
    ...
    return CompetitionLevel.objects.create(
        comp_lvl_typ="qm", comp_lvl_typ_nm="Qualification Match", comp_lvl_order=1
    )
...
class TestScheduleByTypeSerializer:
    ...
    def test_serialize_with_schedule_type_and_schedules(self, schedule_type, schedule):
        ...
        data = {"sch_typ": schedule_type, "sch": [schedule]}
    ...
    def test_serialize_multiple_schedules(self, schedule_type, event, test_user):
        ...
        data = {"sch_typ": schedule_type, "sch": [schedule1, schedule2]}
...
class TestInitSerializer:
    ...
    def test_serialize_with_field_schedule(self, field_schedule):
        ...
        field_schedule = scouting.util.parse_scout_field_schedule(field_schedule)

        data = {"fieldSchedule": [field_schedule]}
    ...
    def test_serialize_with_all_field_schedule(self, field_schedule):
        ...
        data = {"allFieldSchedule": [field_schedule]}
    ...
    def test_serialize_with_all_schedule_by_type(self, schedule_type, schedule):
        ...
        schedule_by_type_data = {"sch_typ": schedule_type, "sch": [schedule]}

        data = {"allSchedule": [schedule_by_type_data]}
    ...
    def test_serialize_with_schedule_types(self, schedule_type):
        ...
        data = {"scheduleTypes": [schedule_type]}
    ...
    def test_serialize_multiple_schedule_types(self):
        ...
        data = {"scheduleTypes": [type1, type2]}
...
class TestPortalSerializerEdgeCases:
    ...
    def test_schedule_by_type_with_empty_schedule_list(self, schedule_type):
        ...
        data = {"sch_typ": schedule_type, "sch": []}
    ...
    def test_init_serializer_with_mixed_data_types(
        ...
        schedule_by_type1 = {"sch_typ": schedule_type, "sch": [schedule]}
        schedule_by_type2 = {"sch_typ": type2, "sch": []}  # Empty schedule list
