...
from .views import UserData, UserLinks, UserGroups, UserProfile, UserEmailConfirmation, UserEmailResendConfirmation, UserRequestPasswordReset, UserPasswordReset, UserRequestUsername
...
urlpatterns = [
    ...
    path('user-links/', UserLinks.as_view()),
